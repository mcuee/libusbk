...
{
    KLST_SYNC_KEEP_UNCHANGED = 1 << 0,
    KLST_SYNC_KEEP_ARRIVALS = 1 << 1,
    KLST_SYNC_KEEP_REMOVALS = 1 << 2,
    KLST_SYNC_ALL = KLST_SYNC_KEEP_UNCHANGED | KLST_SYNC_KEEP_ARRIVALS | KLST_SYNC_KEEP_REMOVALS,
    KLST_SYNC_REFRESH = KLST_SYNC_KEEP_UNCHANGED | KLST_SYNC_KEEP_ARRIVALS,
} KLST_SYNC_FLAGS;

//! Common usb device information structure
typedef struct _KLST_DEV_COMMON_INFO
{
	//! VendorID parsed from \ref KLST_DEV_INFO::DeviceInstance
	UINT Vid;

	//! ProductID parsed from \ref KLST_DEV_INFO::DeviceInstance
	UINT Pid;

	//! Interface number (valid for composite devices only) parsed from \ref KLST_DEV_INFO::DeviceInstance
	UINT MI;
...
typedef struct _KLST_DEV_INFO
{
	...
	*/
	...
	//! Indicates a devices is connection state.
	BOOL Connected;
...
//! Initializes a new usb device list.
	...
	*/
	KUSB_EXP BOOL KUSB_API LstK_Init(
	    __deref_inout PKLST_HANDLE* DeviceList,
...
//! Creates a copy of an existing device list.
	...
	*/
	KUSB_EXP BOOL KUSB_API LstK_Clone(
	    __in PKLST_HANDLE SrcList,
	    __out PKLST_HANDLE* DstList);
