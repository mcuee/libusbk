...
// libusbwK creates this same symbolic name for libusb0.dll compatibility.
...
// Declared in lusbw_general.  These are used, primarily, for log messages.
