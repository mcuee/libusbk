...
// ErrorCodes: NONE
LUSBW_EXP BOOL LUSBW_API LUsbW_Free (__in  WINUSB_INTERFACE_HANDLE InterfaceHandle)
{
	libusb_request request = {0};
	HANDLE deviceHandle;
...
LUSBW_EXP BOOL LUSBW_API WinUsb_Initialize (
    ...
    __out PWINUSB_INTERFACE_HANDLE InterfaceHandle)
{
	return LUsbW_Initialize(DeviceHandle, InterfaceHandle);
}

LUSBW_EXP BOOL LUSBW_API WinUsb_Free (
    __in  WINUSB_INTERFACE_HANDLE InterfaceHandle)
{
	return LUsbW_Free(InterfaceHandle);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_GetAssociatedInterface (
    ...
    __out PWINUSB_INTERFACE_HANDLE AssociatedInterfaceHandle)
{
	return LUsbW_GetAssociatedInterface(InterfaceHandle, AssociatedInterfaceIndex, AssociatedInterfaceHandle);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_GetDescriptor (
    ...
    __out PULONG LengthTransferred)
{
	return LUsbW_GetDescriptor(InterfaceHandle, DescriptorType, Index, LanguageID, Buffer, BufferLength, LengthTransferred);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_QueryInterfaceSettings (
    ...
    __out PUSB_INTERFACE_DESCRIPTOR UsbAltInterfaceDescriptor)
{
	return LUsbW_QueryInterfaceSettings(InterfaceHandle, AlternateInterfaceNumber, UsbAltInterfaceDescriptor);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_QueryDeviceInformation (
    ...
    __out_bcount(*BufferLength) PVOID Buffer)
{
	return LUsbW_QueryDeviceInformation(InterfaceHandle, InformationType, BufferLength, Buffer);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_SetCurrentAlternateSetting (
    ...
    __in  UCHAR SettingNumber)
{
	return LUsbW_SetCurrentAlternateSetting(InterfaceHandle, SettingNumber);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_GetCurrentAlternateSetting (
    ...
    __out PUCHAR SettingNumber)
{
	return LUsbW_GetCurrentAlternateSetting(InterfaceHandle, SettingNumber);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_QueryPipe (
    ...
    __out PWINUSB_PIPE_INFORMATION PipeInformation)
{
	return LUsbW_QueryPipe(InterfaceHandle, AlternateInterfaceNumber, PipeIndex, PipeInformation);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_SetPipePolicy (
    ...
    __in_bcount(ValueLength) PVOID Value)
{
	return LUsbW_SetPipePolicy(InterfaceHandle, PipeID, PolicyType, ValueLength, Value);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_GetPipePolicy (
    ...
    __out_bcount(*ValueLength) PVOID Value)
{
	return LUsbW_GetPipePolicy(InterfaceHandle, PipeID, PolicyType, ValueLength, Value);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_ReadPipe (
    ...
    __in_opt LPOVERLAPPED Overlapped)
{
	return LUsbW_ReadPipe(InterfaceHandle, PipeID, Buffer, BufferLength, LengthTransferred, Overlapped);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_WritePipe (
    ...
    __in_opt LPOVERLAPPED Overlapped)
{
	return LUsbW_WritePipe(InterfaceHandle, PipeID, Buffer, BufferLength, LengthTransferred, Overlapped);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_ControlTransfer (
    ...
    __in_opt  LPOVERLAPPED Overlapped)
{
	return LUsbW_ControlTransfer(InterfaceHandle, SetupPacket, Buffer, BufferLength, LengthTransferred, Overlapped);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_ResetPipe (
    ...
    __in  UCHAR PipeID)
{
	return LUsbW_ResetPipe(InterfaceHandle, PipeID);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_AbortPipe (
    ...
    __in  UCHAR PipeID)
{
	return LUsbW_AbortPipe(InterfaceHandle, PipeID);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_FlushPipe (
    ...
    __in  UCHAR PipeID)
{
	return LUsbW_FlushPipe(InterfaceHandle, PipeID);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_SetPowerPolicy (
    ...
    __in_bcount(ValueLength) PVOID Value)
{
	return LUsbW_SetPowerPolicy(InterfaceHandle, PolicyType, ValueLength, Value);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_GetPowerPolicy (
    ...
    __out_bcount(*ValueLength) PVOID Value)
{
	return LUsbW_GetPowerPolicy(InterfaceHandle, PolicyType, ValueLength, Value);
}
...
LUSBW_EXP BOOL LUSBW_API WinUsb_GetOverlappedResult (
    ...
    __in  BOOL bWait)
{
	return LUsbW_GetOverlappedResult(InterfaceHandle, lpOverlapped, lpNumberOfBytesTransferred, bWait);
}
/*
	LUSBW_EXP PUSB_INTERFACE_DESCRIPTOR WinUsb_ParseConfigurationDescriptor (
		...
		) {return LUsbW_ParseConfigurationDescriptor(ConfigurationDescriptor,StartPosition,InterfaceNumber,AlternateSetting,InterfaceClass,InterfaceSubClass,InterfaceProtocol); }
	...
	LUSBW_EXP PUSB_COMMON_DESCRIPTOR WinUsb_ParseDescriptors (
		...
		) {return LUsbW_ParseDescriptors(DescriptorBuffer,TotalLength,StartPosition,DescriptorType); }
*/
