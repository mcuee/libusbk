...
//      #pragma config EBTR3    = OFF
...
#elif defined(PICKIT2_KIT_USB)      // Configuration bits for PICKIT2 KIT USB Board (based on PIC18F2550)
        #pragma config PLLDIV   = 5         // (20 MHz crystal on PICKit2 Kit USB board)
        #pragma config CPUDIV   = OSC1_PLL2   
        #pragma config USBDIV   = 2         // Clock source from 96MHz PLL/2
        #pragma config FOSC     = HSPLL_HS
        #pragma config FCMEN    = OFF
        ...
        #pragma config WDT      = OFF
        #pragma config WDTPS    = 32768
        #pragma config MCLRE    = OFF		// Make sure this is OFF to have firmware run from USB power
        #pragma config LPT1OSC  = OFF
        #pragma config PBADEN   = OFF
//      #pragma config CCP2MX   = ON
        #pragma config STVREN   = ON
