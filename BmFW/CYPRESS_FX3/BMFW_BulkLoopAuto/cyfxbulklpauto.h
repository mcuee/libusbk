/*
 ## Cypress USB 3.0 Platform header file (cyfxbulklpauto.h)
 ## ===========================
 ##
...
#ifndef _INCLUDED_CYFXBULKLPAUTO_H_
#define _INCLUDED_CYFXBULKLPAUTO_H_
...
#endif /* _INCLUDED_CYFXBULKLPAUTO_H_ */
