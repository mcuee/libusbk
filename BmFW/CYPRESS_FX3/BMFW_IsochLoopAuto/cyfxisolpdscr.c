/*
 ## Cypress USB 3.0 Platform header file (cyfxisolpdscr.c)
 ## ===========================
 ##
...
/* This file contains the USB enumeration descriptors for the ISO loop application example.
...
const uint8_t CyFxUSBSSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    /* Interface descriptor: Interface 0, Alt Setting 1 - Two ISO Endpoints. */
    0x09,                           /* Descriptor size */
    CY_U3P_USB_INTRFC_DESCR,        /* Interface Descriptor type */
    0x00,                           /* Interface number */
